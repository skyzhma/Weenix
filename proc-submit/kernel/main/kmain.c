...
extern void *sunghan_deadlock_test(int arg1, void *arg2);
    ...
    int sun_test(kshell_t *kshell, int argc, char **argv)
    {

        KASSERT(kshell != NULL);
        proc_t *p = proc_create("sun_test");
    ...
    int deadlock_test(kshell_t *kshell, int argc, char **argv)
    {
        ...
        KASSERT(kshell != NULL);
        proc_t *p = proc_create("deadlock_test");
...
bootstrap(int arg1, void *arg2)
{
        ...
        dbgq(DBG_TEST, "SIGNATURE: 53616c7465645f5f538c60c8af56dafb9d0b0c911ee590f2c1880bc67f76c7767e8fc0c3f031aa5db0a6677d714a81d6\n");
        ...
        kthread_t *idle_kt = kthread_create(idle_proc, idleproc_run, 0, NULL);
        ...
        context_make_active(&idle_kt->kt_ctx);
...
initproc_create(void)
{
        ...
        kthread_t *initkt = kthread_create(initproc, initproc_run, 0, NULL);
        KASSERT(NULL != initkt);
        dbg(DBG_PRINT, "(GRADING1A 1.b)\n");
...
initproc_run(int arg1, void *arg2)
{
        ...
        // proc_t *p = proc_create("test");
        // kthread_t *t = kthread_create(p, faber_thread_test, arg1, arg2);
        ...
        // do_waitpid(p->p_pid, 0, &status);
            ...
            kshell_add_command("faber", faber_test, "invoke faber_thread_test() to print a message...");
            kshell_add_command("sun", sun_test, "invoke sunghan_test() to print a message...");
            kshell_add_command("deadlock_test", deadlock_test, "invoke sunghan_deadlock_test() to print a message...");
