...
kthread_create(struct proc *p, kthread_func_t func, long arg1, void *arg2)
{
        ...
        t->kt_wchan = NULL;
        list_init(&t->kt_plink);
        list_init(&t->kt_qlink);
...
kthread_clone(kthread_t *thr)
{
        ...
        t->kt_kstack = alloc_stack();
        context_setup(&(t->kt_ctx), NULL, 0, NULL, t->kt_kstack, DEFAULT_STACK_SIZE, thr->kt_proc->p_pagedir);
        t->kt_ctx.c_kstacksz = DEFAULT_STACK_SIZE;
