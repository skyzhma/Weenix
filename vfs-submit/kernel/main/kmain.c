...
void *vfstest(int arg1, void *arg2) {
    vfstest_main(1, NULL);
    ...
    int vfs_test(kshell_t *kshell, int argc, char **argv)
    {
        ...
        kthread_t *t = kthread_create(p, vfstest, 0, NULL);
...
initproc_run(int arg1, void *arg2)
{
            ...
            kshell_add_command("vfs_test", vfs_test, "invoke vfstest_main() to print a message...");
            kshell_add_command("thread_test", faber_fs_thread_test, "invoke faber_fs_thread_test() to print a message...");
            kshell_add_command("dir_test", faber_directory_test, "invoke faber_directory_test() to print a message...");
